...
OPENROUTER_MODELS: list[tuple[str, str]] = [
    ...
    for mid in (
        "anthropic/claude-fable-5.1", "anthropic/claude-fable-5", "anthropic/claude-opus-5.5", "anthropic/claude-opus-5",
        ...
        "openai/gpt-6-sol", "openai/gpt-5.6-sol", "openai/gpt-5.6-sol-pro",
...
_PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    "openai-api": [
        "gpt-6-sol", "gpt-5.6-sol", "gpt-5.6-sol-pro", "gpt-5.6-terra", "gpt-5.6-terra-pro", "gpt-5.6-luna",
